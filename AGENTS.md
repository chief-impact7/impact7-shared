...
- 테스트: `npm test` (`node --test`). 현재 592개 통과.
...
| 심볼 | 종류 | 시그니처 |
|------|------|---------|
| `ACADEMY_SCOPED_COLLECTIONS` | const | frozen Set(74) — impact7db 이동 63 + payments 11 |
| `GLOBAL_COLLECTIONS` | const | frozen Set(40) — HR·법인/콘텐츠/인증/큐/본사 축 |
